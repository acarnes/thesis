...
\include{tex/lhc-cms}
\include{tex/standard-model}
\include{tex/coinflip}
\include{tex/search_intro}
\include{tex/samples_and_corrections}
\include{tex/maximizing_sensitivity}
\include{tex/modeling}
