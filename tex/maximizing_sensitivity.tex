...
\begin{table}[htb]
   \caption[Feature discretization in the Level-1 Trigger.]{The feature discretization scheme for each mode.}
   \label{tab:bits}
...
\item the $|\Delta\eta|$ between the jets in the two highest mass pairs, \vspace{-10pt}
...
\begin{table}[htb]
  \caption[$H\rightarrow\mu^+\mu^-$ feature ranking.]{The importance is given by the percentage of the signal and background PDFs along that feature that do not overlap.}
...
show a 23\% improvement in the expected upper limit compared to the 15 Run~I $H\rightarrow\mu^+\mu^-$ categories.
...
\begin{table}[htb]
  \caption[The characteristics of each category.]
           ...
           purity, and sensitivity. The purity and sensitivity use the FWHM values for S and B. 
           The background yields are calculated using background models fit to the data in the sidebands.}
  \label{tab:cat_resoln}
  \begin{center}
    \begin{tabular}{crrrrrr}
      \hline
      Category  & Signal FWHM (GeV) & Signal & Background & $\mathrm{S / B}$ (\%) & $\mathrm{S / \sqrt{B}}$ \\  %% & Signal events
      \hline
        c0         &  4.2    &    21.2   &        132300   &        0.00103     &     0.119   \\
        c1         &  7.2    &    22.3   &        9690     &        0.00161     &     0.158   \\
        c2         &  4.1    &    41.1   &        9110     &        0.00302     &     0.284   \\
        c3         &  2.9    &    12.7   &        2250     &        0.00373     &     0.177   \\
        c4         &  7.0    &    11.8   &        3040     &        0.00259     &     0.143   \\
        c5         &  4.0    &    29.2   &        3920     &        0.00497     &     0.313   \\
        c6         &  2.8    &    14.5   &        1350     &        0.00704     &     0.259   \\
        c7         &  7.6    &    5.2    &        1130     &        0.00323     &     0.108   \\
        c8         &  4.2    &    20.3   &        2160     &        0.00629     &     0.293   \\
        c9         &  3.0    &    13.1   &        957      &        0.00904     &     0.282   \\
        c10        &  7.1    &    5.8    &        740      &        0.00526     &     0.144   \\
        c11        &  4.2    &    20.3   &        1520     &        0.00883     &     0.347   \\
        c12        &  3.2    &    13.7   &        745      &        0.0123      &     0.341   \\
        c13        &  4.0    &    8.6    &        381      &        0.0143      &     0.283   \\
        c14        &  4.1    &    13.7   &        344      &        0.0253      &     0.482   \\
      \hline
    \end{tabular}
  \end{center}
\end{table}
...
The BDT distribution in signal quantile is presented in Fig.~\ref{fig:bdt_quantile}
...
\includegraphics[width=0.5\linewidth]{images/bdt_cats/BdtOnH_QM_bkg}
  \caption[The BDT distribution in data and MC by signal quantile.]
  {The BDT distribution in signal quantile in data and MC. The systematic uncertainty is given by the JES and PU.}
