...
The multiplication table can be specified in a more compact notation using the commutator, $[a,b] = ab - ba$.
\begin{equation}
[J_k, J_l] = i\epsilon^{klm}J_m
\end{equation}
...
\begin{equation}
[\sigma_k, \sigma_l] = 2i\epsilon^{klm}\sigma_m
\end{equation}

Defining $J_k = \frac{1}{2} \sigma_k$ fixes this. These matrices act on an array of 2x1 complex numbers called spinors, and this group is called SU(2). Now the idea is to break down four vectors in the same way.  
